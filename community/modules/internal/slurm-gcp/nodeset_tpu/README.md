...
| <a name="input_spot"></a> [spot](#input\_spot) | Specify whether TPU-vms in this nodeset are spot, see https://cloud.google.com/tpu/docs/spot for details. | `bool` | `false` | no |
